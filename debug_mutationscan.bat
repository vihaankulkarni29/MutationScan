...
if exist "MutationScan" (
    echo ✅ MutationScan folder found
    dir MutationScan /w
) else (
    echo ❌ MutationScan folder NOT found
...
if exist "mutationscan_env\Scripts\activate.bat" (
    ...
    python -c "import subscan; print('✅ SubScan import successful')" 2>nul || echo "❌ SubScan import failed"
    python -c "from subscan.domino_tools.ncbi_extractor import NCBIExtractor; print('✅ NCBI Extractor import successful')" 2>nul || echo "❌ NCBI Extractor import failed"
) else (
